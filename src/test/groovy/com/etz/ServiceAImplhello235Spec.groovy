...
class ServiceAImplhello235Spec extends Specification {
	void verifyhello() {
		given:
			...
			subject.serviceB = Mock(com.etz.replay.unit.targets.ServiceBImpl) {
				1 * doServiceB({ p0 -> p0 == INPUTS265[0] }) >> RETURNED265
			...
			subject.providerX = Mock(com.etz.replay.unit.targets.ProviderXImpl) {
				...
				1 * makeX({ p0 -> p0 == INPUTS259[0] }, { p1 -> p1 == INPUTS259[1] }, { p2 -> p2 == INPUTS259[2] }) >> RETURNED259
				...
				1 * makeX({ p0 -> p0 == INPUTS270[0] }, { p1 -> p1 == INPUTS270[1] }, { p2 -> p2 == INPUTS270[2] }) >> RETURNED270
			}
	...
	static final def RETURNED275 = 196
	...
	static final def RETURNED265 = 'null<>null'
