...
class ServiceAImpldoServiceA631Spec extends Specification {
    void verifydoServiceA() {
        ...
        subject.providerX = Mock(com.etz.replay.unit.targets.ProviderXImpl) {
            ...
            1 * makeX({ p0 -> p0 == INPUTS644[0] }, { p1 -> p1 == INPUTS644[1] }, { p2 -> p2 == INPUTS644[2] }) >> RETURNED644
            1 * makeX({ p0 -> p0 == INPUTS647[0] }, { p1 -> p1 == INPUTS647[1] }, { p2 -> p2 == INPUTS647[2] }) >> RETURNED647
        }
