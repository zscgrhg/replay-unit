...
class ServiceAImplhello95Spec extends Specification {
	void verifyhello() {
		given:
			...
			subject.serviceB = Mock(com.etz.replay.unit.targets.ServiceBImpl) {
				1 * doServiceB({ p0 -> p0 == INPUTS127[0] }) >> RETURNED127
				1 * doServiceB({ p0 -> p0 == INPUTS136[0] }) >> RETURNED136
			}
			subject.providerX = Mock(com.etz.replay.unit.targets.ProviderXImpl) {
				...
				1 * makeX({ p0 -> p0 == INPUTS120[0] }, { p1 -> p1 == INPUTS120[1] }, { p2 -> p2 == INPUTS120[2] }) >> RETURNED120
				...
				1 * makeX({ p0 -> p0 == INPUTS131[0] }, { p1 -> p1 == INPUTS131[1] }, { p2 -> p2 == INPUTS131[2] }) >> RETURNED131
			}
			subject.serviceC = Mock(com.etz.replay.unit.targets.ServiceCImpl) {
				1 * doServiceC({ p0 -> p0 == INPUTS135[0] }) >> RETURNED135
	...
	static final def RETURNED135 = 16
	
	static final def RETURNED136 = 'null<>null'
	...
	static final def RETURNED127 = 'null<>null'
	...
	static final def RETURNED139 = 16
