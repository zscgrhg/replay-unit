	...
	void verifyhello() {
		given:
			...
			subject.serviceB = Mock(com.etz.replay.unit.targets.ServiceBImpl) {
				1 * doServiceB({ p0 -> p0 == INPUTS410[0] }) >> RETURNED410
				1 * doServiceB({ p0 -> p0 == INPUTS415[0] }) >> RETURNED415
			}
			subject.providerX = Mock(com.etz.replay.unit.targets.ProviderXImpl) {
				...
				1 * makeX({ p0 -> p0 == INPUTS396[0] }, { p1 -> p1 == INPUTS396[1] }, { p2 -> p2 == INPUTS396[2] }) >> RETURNED396
				...
				1 * makeX({ p0 -> p0 == INPUTS407[0] }, { p1 -> p1 == INPUTS407[1] }, { p2 -> p2 == INPUTS407[2] }) >> RETURNED407
			...
			subject.serviceC = Mock(com.etz.replay.unit.targets.ServiceCImpl) {
				1 * doServiceC({ p0 -> p0 == INPUTS416[0] }) >> RETURNED416
