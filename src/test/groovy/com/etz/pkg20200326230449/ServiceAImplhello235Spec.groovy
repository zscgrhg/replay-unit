...
class ServiceAImplhello235Spec extends Specification {
	void verifyhello() {
		given:
			...
			subject.providerX = Mock(com.etz.replay.unit.targets.ProviderXImpl) {
				...
				1 * makeX({ p0 -> p0 == INPUTS255[0] }, { p1 -> p1 == INPUTS255[1] }, { p2 -> p2 == INPUTS255[2] }) >> RETURNED255
				1 * makeX({ p0 -> p0 == INPUTS260[0] }, { p1 -> p1 == INPUTS260[1] }, { p2 -> p2 == INPUTS260[2] }) >> RETURNED260
	...
	static final def RETURNED277 = 49
